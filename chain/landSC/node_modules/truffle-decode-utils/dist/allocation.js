...
(function (Allocation) {
     ...
     */
    function allocateDeclarations(declarations, refs, allocations, //sorry
    slot = { offset: new bn_js_1.default(0) }, index = evm_1.EVM.WORD_SIZE - 1) {
        ...
        for (let declaration of declarations) {
            let { from, to, next, children } = allocateDeclaration(declaration, refs, slot, index, allocations);
    ...
    function allocateDeclaration(declaration, refs, slot, index, allocations) {
